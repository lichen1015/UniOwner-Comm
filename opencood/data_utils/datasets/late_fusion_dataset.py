...
def getLateFusionDataset(cls):
    ...
    class LateFusionDataset(cls):
        ...
        def get_item_train(self, base_data_dict):
            ...
            selected_cav_processed = self.get_item_single_car(selected_cav_base, selected_cav_base)
        ...
        def get_item_test(self, base_data_dict, idx):
            ...
            for cav_id in cav_id_list:
                ...
                selected_cav_processed = \
                    self.get_item_single_car(selected_cav_base, base_data_dict[ego_id])
        ...
        def get_item_single_car(self, selected_cav_base, ego_cav_base):
            ...
            """
            selected_cav_processed = {}
            _, ego_pose_clean = ego_cav_base['params']['lidar_pose'], ego_cav_base['params']['lidar_pose_clean']
            ...
            if self.load_lidar_file or self.visualize:
                ...
                # for late fusion, processed_lidar is the processed lidar data
                # for intermediate fusion, processed_lidar is the original lidar data and processed_features is the processed lidar data
            ...
            # used to generate the final GT, and finally all the GTs of all CAVs will be merged together
            selected_cav_processed.update(
                {
        ...
        def post_process(self, data_dict, output_dict):
            ...
            gt_box_tensor = self.post_processor.generate_gt_bbx(data_dict, project_to_ego=False)
