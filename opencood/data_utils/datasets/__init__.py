...
from opencood.data_utils.datasets.intermediate_late_fusion_dataset import getIntermediatelateFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['late', 'intermediate', 'intermediate2stage', 'early', 'intermediatelate']
