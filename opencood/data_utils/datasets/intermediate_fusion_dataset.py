...
def getIntermediateFusionDataset(cls):
    ...
    class IntermediateFusionDataset(cls):
        ...
        # Used for preprocessing and generating GT according to the selected CAV and ego vehicle.
        ...
        def collate_batch_test(self, batch):
            ...
            # because we have already transformed the box to ego coord in the dataloader, in postprocess, we will
            # transform the box to ego coord again, so we set the transformation matrix to identity matrix.
