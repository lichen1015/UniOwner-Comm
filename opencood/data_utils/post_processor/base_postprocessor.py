...
class BasePostprocessor(object):
    ...
    def generate_gt_bbx(self, data_dict, project_to_ego=True):
        """
    ...
    def generate_gt_bbx_by_iou(self, data_dict, project_to_ego=True):
        """
        ...
        for cav_id, cav_content in data_dict.items():
            # used to project gt bounding box to ego space
            # object_bbx_center is clean.
            # if 'transformation_matrix_clean' in cav_content:
            #     transformation_matrix = cav_content['transformation_matrix_clean']
            # else:
            #     transformation_matrix = cav_content['transformation_matrix']\
            transformation_matrix = cav_content['transformation_matrix'] \
